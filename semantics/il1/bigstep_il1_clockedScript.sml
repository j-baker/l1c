...
val (bs_il1_c_rules, bs_il1_c_ind, bs_il1_c_cases) = Hol_reln `
    ...
    (!cl e v s.
        bs_il1_expr (e, s) v
    ==> bs_il1_c cl (IL1_Expr e, s) (SOME (v, s, cl))) /\

    (* Assign *)
    (!cl l e s n.
       (User l ∈ FDOM s /\
        bs_il1_expr (e, s) (IL1_Integer n))
    ==> bs_il1_c cl (IL1_Assign (User l) e, s) (SOME (IL1_ESkip, s |+ (User l, n), cl))) /\

    (!cl l e s n.
        bs_il1_expr (e, s) (IL1_Integer n)
    ==> bs_il1_c cl (IL1_Assign (Compiler l) e, s) (SOME (IL1_ESkip, s |+ (Compiler l, n), cl))) /\

    (* Seq *)
    (!cl cl' cl'' e1 e2 v s s' s''.
        (bs_il1_c cl (e1, s) (SOME (IL1_ESkip, s', cl')) /\
         bs_il1_c cl' (e2, s') (SOME (v, s'', cl'')))
     ==> bs_il1_c cl (IL1_Seq e1 e2, s) (SOME (v, s'', cl''))) /\

    (!cl e1 e2 s.
         bs_il1_c cl (e1, s) NONE
     ==> bs_il1_c cl (IL1_Seq e1 e2, s) NONE) /\
    ...
    (!cl cl' e1 e2 e3 v s s'.
        (bs_il1_expr (e1, s) (IL1_Boolean T) /\
         bs_il1_c cl (e2, s) (SOME (v, s', cl')))
     ==> bs_il1_c cl (IL1_SIf e1 e2 e3, s) (SOME (v, s', cl'))) /\
