...
val CLOCKED_IMP_UNCLOCKED_IL1 = store_thm("IL1_CLOCKED_IMP_UNCLOCKED", ``!c p r.bs_il1_c c p r ==> !v s' c'.(r = SOME (v, s', c')) ==> bs_il1 p v s'``,
ho_match_mp_tac bs_il1_c_strongind THEN rw [] THEN rw [Once bs_il1_cases] THEN metis_tac [clocked_imp_bs_il1_expr]);

val UNCLOCKED_IMP_CLOCKED_IL1 = store_thm("IL1_UNCLOCKED_IMP_CLOCKED",
